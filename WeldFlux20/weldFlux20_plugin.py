...
class WeldFlux20_plugin(AFXForm):
    ...
    def __init__(self, owner):
        ...
        self.cmd = AFXGuiCommand(mode=self, method='kernel',
            objectName='T_plain20', registerQuery=False)
        pickedDefault = ''
    ...
    def getFirstDialog(self):
        ...
        import weldFlux20DB
        return weldFlux20DB.WeldFlux20DB(self)
...
toolset.registerGuiMenuButton(
    buttonText='WeldFlux20', 
    object=WeldFlux20_plugin(toolset),
    messageId=AFXMode.ID_ACTIVATE,
    icon=None,
    kernelInitString='import T_plain20',
